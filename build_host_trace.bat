...
if not exist build\hostobj_trace mkdir build\hostobj_trace
cd build\hostobj_trace
...
:link_headless
link /nologo /out:..\dkc1_headless_trace.exe @objects.rsp ..\main_headless.obj ws2_32.lib user32.lib advapi32.lib
...
set LINK_RETRIES=0
:link_desktop
link /nologo /out:..\dkc1_desktop_trace.exe @objects.rsp ..\main_win32.obj ws2_32.lib user32.lib advapi32.lib gdi32.lib winmm.lib comdlg32.lib
...
:build_ok
link /nologo /out:..\dkc1_layer_capture_trace.exe @objects.rsp ..\main_layer_capture.obj ws2_32.lib user32.lib advapi32.lib
if errorlevel 1 exit /b 1
echo HOST_BUILD_OK
