...
| Dixie Kong Country | `runner/dkc1_dixie_mod.*` + `docs/DIXIE_HD_MAC.md` | live — pinned full recompilation variant; separate process and saves; stock path fails closed |
